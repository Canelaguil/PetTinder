...
' <div class="panel-heading"><button class="btn btn-xs btn-warning fav-btn"></button><span class="api_input"></span></div>'+
...
function favCall(id){ 
    ...
    var baseURL = "https://api.petfinder.com/pet.get?key=8788a1328e6d39c137797752065c325c&id=";
...
function firstCall(){
    var sampleURL = "https://api.petfinder.com/pet.find?animal=cat&key=8788a1328e6d39c137797752065c325c&location=53217&count=2&output=basic&format=json&callback=?";
    $.ajax({
        dataType: "json",
        url: sampleURL,
        success:(function(data){
